...
** QUICK INSTALL
   ...
   There are better ways, probably using symlinks.
...
*** BINDS
    ...
    - Short M-x aliases and the fuzzy completion from there as needed. See [[https://github.com/a-schaefers/spartan-emacs/blob/master/spartan-layers/spartan-binds-global.el][spartan-binds-global.el]].
