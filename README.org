...
Most all layers now load on first-time setup, sans more specific language layers that can be enabled manually.
...
Reminder, this is an opinionated framework.
  ...
  - Theme
    ...
    Moved to a clean-looking "github" theme and modeline back at the bottom
