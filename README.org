...
*** Breaking Changes Sun 10 Sep 2023 02:17:06 PM MDT

I released quite a few breaking changes over the past few days. I should be done doing that, now. If having an issue, git pull, and then rm -f ~/.emacs.d/spartan.el to regenerate your config file.
...
- Clojure (paredit, lsp)
- C (linux kernel coding standards, lsp)
- Bash  (shellcheck)
