...
spartan-library has most of the layers.
copy ones you want in to spartan.d

To update without breaking, move your ~/.emacs.d/spartan.el file out of the way for a moment to a safe place, restart emacs.
Then 'C-c i' and copy your old stuff that you want to keep back in to that one, or reconfigure the one new one, your choice.
